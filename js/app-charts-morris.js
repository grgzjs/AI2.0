...
var App = (function () {
	...
	App.chartsMorris = function( ){
	  ...
	  //Bar chart
	  function bar_chart(){
			var color1 = tinycolor( App.color.primary ).lighten( 15 ).toString();
	  ...
	  function donut_chart(){
	  	var color1 = App.color.primary;
      var color2 = tinycolor( App.color.primary ).lighten( 20 );
      var color3 = tinycolor( App.color.primary ).lighten( 10 );
