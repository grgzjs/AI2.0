    ...
    <div class="mai-wrapper mai-sign-up">
      <div class="main-content container">
        <div class="splash-container row">
          <div class="col-md-6 form-message"><img class="logo-img mb-4" src="src/youlogo.svg" alt="logo" width="338" height="56"><span class="splash-description text-center mt-4 mb-4">Sign up</span>
            <form class="sign-up-form">
              ...
              <div class="form-group sign-up-submit"><a class="btn btn-lg btn-primary btn-block" href="index.html" data-dismiss="modal">Sign up</a></div>
