    ...
    <nav class="navbar navbar-expand navbar-dark mai-top-header">
        <div class="container"><a class="paddingright-20" href="#">AI Soft V1.0</a>
            ...
            <ul class="navbar-nav float-lg-right mai-icons-nav">
                <li class="dropdown nav-item mai-messages"><a class="nav-link dropdown-toggle" href="#"
                                ...
                                <div class="content">
                                    <ul>
                                        <li><a href="#">
                                                ...
                                                <div class="content"><span class="date">16 Sept</span><span
                                                        class="name">Julio Sosa</span><span class="desc">message board
                                                        en camino. </span></div>
                                            </a></li>
                                        <li><a href="#">
                                                <div class="img"><img src="assets/img/avatars/img2.jpg" alt="Avatar">
                                                </div>
                                                <div class="content"><span class="date">4 Sept</span><span
                                                        class="name">Gustavo </span><span class="desc">dale play.</span>
                                                </div>
                                            </a></li>
                                        <li><a href="#">
                                                <div class="img"><img src="assets/img/avatars/img3.jpg" alt="Avatar">
                                                </div>
                                                <div class="content"><span class="date">13 Aug</span><span
                                                        class="name">Lupi</span><span class="desc">Dale, yo sigo
                                        ...
                                        <li><a href="#">
                                                ...
                                                <div class="content"><span class="date">13 Aug</span><span
                                                        class="name">Julieta</span><span class="desc">Esta bueno
                                                        esto.</span></div>
                                            </a></li>
                                    </ul>
                                </div>
                ...
                <li class="dropdown nav-item mai-notifications"><a class="nav-link dropdown-toggle" href="#"
                        data-toggle="dropdown" role="button" aria-expanded="false"><span
                            class="icon s7-bell"></span><span class="indicator"></span></a>
                    <ul class="dropdown-menu">
                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#">
                                                ...
                                                <div class="content"><span class="desc">You have a new fiend request
                                                        pending from <strong>Julieta</strong>.</span><span
                                                        class="date">2 days ago</span></div>
                                            </a></li>
                                        <li><a href="#">
                                                <div class="icon"><span class="s7-graph1"></span></div>
                                                <div class="content"><span class="desc">Your site visits have increased
                                                        <strong>15.5%</strong> more since the last week.</span><span
                                                        class="date">2 hours ago</span></div>
                                            </a></li>
                                        <li><a href="#">
                                                <div class="icon"><span class="s7-check"></span></div>
                                                <div class="content"><span class="desc">This is a new message for my
            ...
            <ul class="nav navbar-nav float-lg-right mai-user-nav">
                <li class="dropdown nav-item"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"
                        role="button" aria-expanded="false"><img src="assets/img/avatar.jpg" alt="Avatar"><span
                            class="user-name">Demo Account</span><span class="angle-down s7-angle-down"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#"><span
                                class="icon s7-home"></span>My Account</a><a class="dropdown-item"
                            href="menuprofile.php"><span class="icon s7-user"></span>Profile</a><a class="dropdown-item"
                            href="menuprofile.php"><span class="icon s7-tools"></span>Settings</a><a
                            class="dropdown-item" href="login.php"><span class="icon s7-power"></span>Log Out</a></div>
                </li>
            </ul>
        </div>
    </nav>
                ...
                <nav class="navbar navbar-expand-md">
                    ...
                    <div class="navbar-collapse collapse mai-nav-tabs" id="mai-navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item parent open"><a class="nav-link" href="#" role="button"
                                    aria-expanded="false"><span
                                        class="icon s7-portfolio"></span><span>Operaciones</span></a>
                                <ul class="mai-nav-tabs-sub mai-sub-nav nav">
                                    <li class="nav-item"><a class="nav-link" href="opsmain.php"><span
                                                class="icon s7-diamond"></span><span class="name">Base de
                                                vuelos</span></a>
                                    </li>
...
?>
  ...
  ?>
                                                ...
                                                <input type="hidden" id='<?php echo "tramoid$itramo" ?>' name='tramoid'
                                                    value="<?php echo $rowdetail['id'] ?>">
                                                <?php $itramo++; } ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-header">Informacion de Tripulacion<span
                                                class="card-subtitle">Ingresa los detalles de Tripulacion</span></div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-10 col-lg-12">
                                                <div class="buscador">
                                                    <select class="form-control custom-select " style="width:20em"
                                                        name="tripulacion" id='tripulacion'
                                                        onchange='javascript:updatepilot()'>
                                                        <option value="">...</option>
...
?>
                                                        ...
                                                        <option
                                                            value="<?php echo $row['id'].'*'.$row['pais'].'*'.$row['f_nacimiento'].'*'.$row['dnipass'].'*'.$row['licencia'].'*'.$row['funcion'] ?>">
...
?>
                                                    ...
                                                    <div class="" style="width:10em">
                                                        <input class="form-control " type="text" value=""
                                                            placeholder="F.Nacimiento" id='f_nacimientopilot'
                                                            name="f_nacimiento">
                                                    </div>
                                                    <div class="" style="width:10em">
                                                        <input class="form-control ch-width10" type="text" value=""
                                                            placeholder="Pais" id='paispilot' name="Pais">
                                                        <input class="form-control ch-width10" type="hidden" value=""
                                                            id='idpilot' name="idpilot">
                                                    </div>
                                                    <div class="" style="width:10em">
                                                        <input class="form-control ch-width10" type="text" value=""
                                                            placeholder="DNI/PASS" id='dnipasspilot' name="dnipass">
                                                    </div>
                                                    <div class="" style="width:10em">
                                                        <input class="form-control" type="text" value=""
                                                            placeholder="Licencia" id='licenciapilot' name="Licencia">
                                                    </div>
                                                    <div class="" style="width:9em">
                                                        ...
                                                        <select class="form-control custom-select" name="funcion"
                                                            id='funcion'>
                                                            <option value="Piloto"
                                                                <?php if ($row['funcion'] == 'Piloto') { echo 'selected'; } ?>>
                                                                Piloto</option>
                                                            <option value="Copiloto"
                                                                <?php if ($row['funcion'] == 'Copiloto') { echo 'selected'; } ?>>
                                                                Copiloto</option>
                                                            <option value="TCP"
                                                                <?php if ($row['funcion'] == 'TCP') { echo 'selected'; } ?>>
                                                                TCP</option>
                                                        </select>
                                                    </div>
                                                    <div
                                                        style="display:flex;justify-content:space-between;width:5%;align-items:center;margin:5px">
                                                        <?php 
                      //$index=0;
                      $itramo=1;
                     ...
                     ?>
                                                        <input id="<?php echo 'pilotchck'.$itramo ?>" type="checkbox"
                                                            style="width:2em;height:2em" value="<?php echo $itramo ?>"
                                                            name="<?php echo 'pax'.$rowdetail['id']?>"> <span
                                                            class=""></span>
                                                        <?php 
                      $itramo++;
                       }
                      ?>
                                                    ...
                                                    <div class="input-group-append">
                                                        <button class="btn btn-primary "
                                                            onclick='javascript:addbutton2()' type="button">+</button>
                                                    </div>
                                                </div>
                      ...
                      ?>
                                                        ...
                                                        <div class="input-group-append">
                                                            <input class="form-control col-12 col-sm-3 col-lg-3"
                                                                value="<?php echo $rowp['last_name'].', '.$rowp['first_name']?>"
                                                                readonly>
                                                            <input class="form-control col-12 col-sm-2 col-lg-2"
                                                                value="<?php echo $rowp['f_nacimiento']?>" readonly>
                                                            <input class="form-control col-12 col-sm-2 col-lg-2"
                                                                value="<?php echo $rowp['pais']?>" readonly>
                                                            <input class="form-control col-12 col-sm-1 col-lg-1"
                                                                value="<?php echo $rowp['licencia']?>" readonly>
                                                            <input class="form-control col-12 col-sm-1 col-lg-1"
                                                                value="<?php echo $rowp['dnipass']?>" readonly>
                                                            <input class="form-control col-12 col-sm-1 col-lg-1"
                                                                value="<?php echo $rowp['funcion']?>" readonly>
                                                            <?php 
                      // $index=0;
                      // $itramo=1;
                      // $detailleg = mysqli_query($con, $sql);
                      ...
                      //     // if ( == $rowdetail['id']) {
                               ?>
                                                            <!-- <input class="col-6 col-sm-1 col-lg-1" type="checkbox" name="<?php //echo 'pax'.$rowdetail['id']?>" disabled='disabled' checked> -->
                                                            <?php
                      //     // }
                      // $index++;
                      // }
                      ...
                      foreach ($tramoids as $tramo) {
                          if (in_array($tramo, $pilot_tramos)) {
                            ?>
                                                            <input class="form-control col-6 col-sm-1 col-lg-1" type="checkbox"
                                                                name="<?php echo 'pax'.$tramo?>" disabled='disabled'
                                                                checked>
                                                            <?php
                          }
                          else {
                      ...
                      ?>
                                                            ...
                                                            <button class="form-control btn btn-dark btn-danger btn-xs "
                                                                onclick="javascript:deletepax2(<?php echo $rowp['contact_id']?>,<?php echo $quote?>,event)">
                      ...
                      ?>
                                            ...
                                            <div class="card-header">Informacion de Pasajeros<span
                                                    class="card-subtitle">Ingresa los detalles de Pasajeros</span></div>
                                            <br>
                                            <div class="form-group row">
                                            <label class="col-12 col-sm-1 col-form-label text-sm-right"></label>
                                            <div class="col-12 col-sm-10 col-lg-12">
                                            <div class="buscador">
                                                ...
                                                <div class="" style="width:16em">
                                                    <select class="form-control custom-select" name="cliente"
                                                        id='cliente' onchange='javascript:updatepax()'>
...
?>
                                                        ...
                                                        <option
                                                            value="<?php echo $row['id'].'*'.$row['pais'].'*'.$row['f_nacimiento'].'*'.$row['dnipass'] ?>">
                                                            <?php echo $row['last_name'].', '.$row['first_name']?>
                                                        </option>
                                                        <?php
  }
  ?>
                                                ...
                                                <div class="" style="width:10em">
                                                    <input class="form-control" type="text" value="" placeholder="Pais"
                                                        id='pais' name="pais">
                                                    <input class="form-control" type="hidden" value="" id='idpax'
                                                        name="idpax">
                                                </div>
                                                <div class="" style="width:10em">
                                                    <input class="form-control" type="text" value=""
                                                        placeholder="F.Nacimiento" id='f_nacimiento'
                                                        name="f_nacimiento">
                                                </div>
                                                <div class="" style="width:10em">
                                                    <input class="form-control" type="text" value=""
                                                        placeholder="DNI/PASS" id='dnipass' name="dnipass">
                                                </div>
                                                <div
                                                    style="display:flex;justify-content:space-between;width:5%;align-items:center;margin:5px">
                                                    <?php 
                     ...
                     ?>
                                                    <input id="<?php echo 'paxchck'.$itramo ?>" type="checkbox"
                                                        style="width:2em;height:2em" value="<?php echo $itramo ?>"
                                                        name="<?php echo 'pax'.$rowdetail['id']?>"> <span
                                                        class=""></span>
                                                    <?php 
                      ...
                      ?>
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn btn-primary " onclick='javascript:addbutton()'
                                                        type="button">+</button>
                                                </div>
                                            </div>
                                                <div class="form-group row container">
                      ...
                      ?>
                                                            <button class="form-control btn btn-dark btn-danger " type="button"
                                                                onclick="javascript:deletepax2(<?php echo $rowp['contact_id']?>,<?php echo $quote?>,event)">
                                                                <span class="s7-trash"></span>
                                                            </button>
                                                        </div>
...
?>
    ...
    function addbutton2() {
        ...
        //   let chck_Value = document.getElementById('chck' + (index + 1))
        //   if (chck_Value != null) {
        //     input8.value = chck_Value.value
        //     inputchck.push(input8)
        //   }
        ...
        // for (let i = 0; i < inputchck.length; i++) {
        //   inputchck[i].classList.add('form-control', 'col-1')
        //   document.getElementById('divpilot').appendChild(inputchck[i])
        // }
