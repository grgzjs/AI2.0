...
$rows_aircraft = mysqli_query($con, "SELECT img_dir FROM aircraft_img WHERE matricula=$aircraft;");

//$num_aircraft_row = mysqli_num_rows($rows_aircraft);

$html = '
<div style="text-align:center;">
    <img src="' . $rowcompany['logo_dir'] . '" alt="Logo">
</div>
    <table> 
        <tr>
            <td>Quote # : ' . $aux . '</td>
...
while($aircraft_row=mysqli_fetch_assoc($rows_aircraft)){
    $html .= '<img src="'.$aircraft_row["img_dir"].'" alt="Logo">';
};
$html .= '
</div>
<br>
