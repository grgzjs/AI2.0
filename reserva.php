                      ...
                      <div class="navbar-collapse collapse mai-nav-tabs" id="mai-navbar-collapse">
                        <ul class="nav navbar-nav">
                                    ...
                                    <li class="nav-item parent open"><a class="nav-link" href="#" role="button" aria-expanded="false"><span class="icon s7-piggy"></span><span>Contabilidad</span></a>
                                      <ul class="mai-nav-tabs-sub mai-sub-nav nav">
                                                  <li class="nav-item"><a class="nav-link" href="contabilidadgastos.php"><span class="icon s7-shopbag"></span><span class="name">Gastos Gral</span></a>
                                                  </li>
...
<!--COMIENZO REGISTRACION PRINCIPAL-->
  ...
  <?php
    $quote = $_GET['id'];
    $sql_detail = 'select * from invoice_detail where id_invoice=' . $quote;
              ...
              <div class="wizard wizard-ux" id="wizard1">
                ...
                <div class="step-content">
                  ...
                  <!-- <div class="step-pane active">
                    ...
                    <div class="col-12 col-sm-8 col-lg-6">
                    <select class="form-control custom-select" id="tipo_ingreso">
...
function save_all() {
    ...
    document.body.appendChild(form)
    form.action = 'reserva.php?id=<?php echo $quote ?>'
    form.method = 'post'
    // form.submit()
    button1.click()
}
